...
export declare function verifyGoldshellHashRate(hostedMiner: HostedMiner): Promise<string>;
export declare function verifyGoldshellFanSpeed(hostedMiner: HostedMiner): Promise<string>;
export declare function verifyGoldshellTemperature(hostedMiner: HostedMiner): Promise<string>;
