...
export declare const HASHRATE_VERIFICATION_FUNCTION: Record<MinerApiType, (hostedMiner: HostedMiner) => Promise<MinerCommandResolution>>;
export declare const FAN_SPEED_VERIFICATION_FUNCTION: Record<MinerApiType, (hostedMiner: HostedMiner) => Promise<MinerCommandResolution>>;
export declare const TEMPERATURE_VERIFICATION_FUNCTION: Record<MinerApiType, (hostedMiner: HostedMiner) => Promise<MinerCommandResolution>>;
