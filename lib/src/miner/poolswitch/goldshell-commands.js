...
function switchGoldshellPool(params) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        Failed trying to switch Goldshell's Pool: ${(0, pretty_format_1.format)(params)}.
        Error msg: ${e}.`;
...
function verifyGoldshellPool(params) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        Failed to verify the mining pool for an Goldshell: ${(0, pretty_format_1.format)(params)}.
        Error msg: ${e}.
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        return yield (0, axios_1.default)({
          ...
          HashRate not within the expected bounds: 
            ...
            Please check miner: ${(0, pretty_format_1.format)(ipAddress)}`),
                });
            }
