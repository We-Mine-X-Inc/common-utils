...
function rebootGoldshellMiner(params) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return yield loginToMiner(params.hostedMiner.ipAddress).then(({ ipAddress, authToken }) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield (0, axios_1.default)({
                method: "get",
...
function verifyGoldshellHashRate(hostedMiner) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return yield loginToMiner(hostedMiner.ipAddress)
            .then(({ ipAddress, authToken }) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield (0, axios_1.default)({
                method: "get",
...
function verifyGoldshellTemperature(hostedMiner) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return yield loginToMiner(hostedMiner.ipAddress)
            .then(({ ipAddress, authToken }) => (0, axios_1.default)({
            method: "get",
            url: `http://${ipAddress}/mcb/cgminer?cgminercmd=devs`,
            headers: getRequestHeaders(authToken),
        }))
