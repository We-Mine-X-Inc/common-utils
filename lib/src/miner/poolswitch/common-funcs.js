...
exports.isOutletTempWithinBounds = exports.isInletTempWithinBounds = exports.isFanSpeedWithinBounds = exports.isHashRateWithinBounds = exports.getUnfulfilledCommandError = void 0;
const wemine_apis_1 = require("wemine-apis");
function getUnfulfilledCommandError(relatedMinerErrorType) {
    return {
        minerErrorType: relatedMinerErrorType,
        stackTrace: "Unfufilled/Unreachable diagnosis.",
    };
}
exports.getUnfulfilledCommandError = getUnfulfilledCommandError;
